...
def main():
    ...
    parser.add_argument('csv_file_path', type=str, help='Path to the CSV file to filter.')
    ...
    entire_data_set = DataSet.from_file(csv_file_path)  # Load the entire data set
    ...
    for sensor in all_sensors:
        ...
        data_set.apply_filter(
            lambda data: select_filter(use_moving_average_filter)(moving_average_filter_sample_count, data))
    ...
    entire_filtered_data_set = DataSet(time, hardware_timestamp, extract_id, trigger, accelerometer_x, accelerometer_y,
    ...
    entire_filtered_data_set.write_to_file(f"{file_name}_{filter_kind}{file_extension}")
